...
export function FieldLegend() {
  return (
    <div className="mb-4 grid grid-cols-2 gap-x-6 gap-y-2 rounded-lg border border-cyan-500/25 bg-cyan-500/15 px-4 py-3 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
