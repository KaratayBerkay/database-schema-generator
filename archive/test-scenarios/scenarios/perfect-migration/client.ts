...
export const PROJECT_NAME = "Perfect Migration Scenario";
export const V1_VERSION = "1.0111";
...
type RestrictionRow = { key: string; type: "UNIQUE" | "INDEX"; fields: string[]; dbName?: string };
...
export const api = {
  ...
  restrictions: {
    list: (input: { projectName: string; version: string; modelName: string }) =>
      call<{ restrictions: RestrictionRow[] }>("restrictions.list", "query", input),
    create: (input: {
      projectName: string;
      version: string;
      modelName: string;
    ...
    }) => call<unknown>("restrictions.delete", "mutation", input),
  },
};
